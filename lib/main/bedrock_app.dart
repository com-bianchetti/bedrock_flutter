...
import 'package:bedrock_flutter/main/bedrock_provider.dart';
...
class BedrockApp extends StatelessWidget {
  ...
  /// The theme to use for the Bedrock app.
  final BedrockThemeData? bedrockTheme;
  ...
  /// Creates a BedrockApp that internally uses a MaterialApp.
  ///
  ...
  /// unsupported route.
  ///
  /// This class creates an instance of [MaterialApp].
  const BedrockApp({
    super.key,
    this.navigatorKey,
  ...
  /// Creates a [BedrockApp] that uses the [Router] instead of a [Navigator].
  ///
  /// {@macro flutter.widgets.WidgetsApp.router}
  const BedrockApp.router({
    super.key,
    this.bedrockTheme,
    this.colorScheme,
    this.scaffoldMessengerKey,
